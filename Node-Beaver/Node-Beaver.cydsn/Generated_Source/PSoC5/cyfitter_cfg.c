...
#define BS_UDB_1_4_1_CONFIG_VAL ((const uint8 CYFAR *)0x480009F8u)
...
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x48000AACu)

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x48000AB4u)
